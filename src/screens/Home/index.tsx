...
export function Home(){
   ...
   async function progressNotification(transferred: number, transferable: number){
    ...
    useEffect(() => {
        ...
        return () => syncSession.removeProgressNotification(progressNotification) //como é praticamente um listener, coloquei um return para removê-lo da memória
    }, [])
    ...
    return(
        <Container>
           ...
           <FlatList
            ...
            ListEmptyComponent={(
                <Label>Nenhum registro de veículo utilizado.</Label>
            )}
           />
            </Content>
        </Container>
